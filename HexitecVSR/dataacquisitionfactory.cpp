                                               ...
                                               ProgressForm *progressForm, ProcessingBufferGenerator *processingBufferGenerator, QObject *parent)
{
   ...
   detectorFactory->createVSRDetector(aspectFilename, parent);
   ...
   try
   {
      detectorFactory->getVSRDetector()->initialiseConnection();
      detectorFactory->getVSRDetector()->beginMonitoring();
   }
