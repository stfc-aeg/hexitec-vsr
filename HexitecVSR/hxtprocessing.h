...
public:
	...
	/// HexitecVSR functions to support run()
...
signals:
    ...
    void hexitechBufferToDisplay(unsigned short* hxtBuffer, QString fileName);      /// HexitecVSR Added
    void hexitechSpectrumFile(QString spectrumFile);
    void hexitechConsumedFiles(vector<string> fileNames);
    void hexitechConsumedBuffers(vector<unsigned short*> bufferNames);   /// HexitecVSR Added
...
//    QMutex motorMutex;
    ...
    /// HexitecVSR Addition; Allow user to disable logging
