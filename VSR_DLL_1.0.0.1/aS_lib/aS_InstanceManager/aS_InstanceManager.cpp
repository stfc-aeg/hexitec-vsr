...
InstanceManager::InstanceManager(u32 TimeOut)
{
...
i32 InstanceManager::AddInstance(void *InstanceHandle)
{
	i32 dwWaitResult;
...
i32 InstanceManager::SetInstanceBusy(void *InstanceHandle)
{
	i32			dwWaitResult = 0;
	u32			Position = 0;
	i32			iResult = 0;
...
i32 InstanceManager::SetInstanceReady(void *InstanceHandle)
{
	i32			dwWaitResult = 0;
	u32			Position = 0;
	i32			iResult = 0;
...
i32 InstanceManager::RemInstance(void *InstanceHandle)
{
	i32			dwWaitResult = 0;
	u32			Position = 0;
	i32			iResult = 0;
...
i32 InstanceManager::FindInstance(void *InstanceHandle, u32 *Position)
{
	u32		 i = 0;
