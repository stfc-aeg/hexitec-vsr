...
// aSpectVSR -----------------------------------------------------------------
//
// MessageId: AS_VSR_RESOLUTION_NOT_MATCH
//
// MessageText:
//
// Resolution of VSR1 does not match with resolution of VSR2. Check sensor setup register settings (%1!d!).
//
#define AS_VSR_RESOLUTION_NOT_MATCH      ((DWORD)0xC0030001L)

//
// MessageId: AS_VSR_CH_TRAINING_NOT_COMPLETED
//
// MessageText:
//
// Channel training not completed. Check cable connections (%1!d!).
//
#define AS_VSR_CH_TRAINING_NOT_COMPLETED ((DWORD)0xC0030002L)
